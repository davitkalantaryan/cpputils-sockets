...
#ifndef COMMON_IO_SOCKET_BASE_HPP
#define COMMON_IO_SOCKET_BASE_HPP

#include <common_sockets_internal.h>

#if defined(_MSC_VER) & (_MSC_VER>=1913)
#ifndef CINTERFACE
#define CINTERFACE_defined_here
#define CINTERFACE
#endif
#endif
...
class COMMON_SOCKETS_HANDLER_EXPORT Base : public common::io::Base
{
public:
	Base();
...
COMMON_SOCKETS_HANDLER_EXPORT const char* GetIPAddress(const sockaddr_in* addr);
COMMON_SOCKETS_HANDLER_EXPORT const char* GetHostName(const sockaddr_in* addr, char* buffer, int buffLen);
COMMON_SOCKETS_HANDLER_EXPORT int  GetPort(const sockaddr_in* a_addr);
COMMON_SOCKETS_HANDLER_EXPORT const char* GetOwnIp4Address(char* pcBuffer, int bufferLength);
COMMON_SOCKETS_HANDLER_EXPORT const char* GetIp4AddressFromHostName(const char* hostName);
#endif  // #ifdef sockaddr_in_using_ok


}}}  // namespace common{ namespace io{ namespace socket{

#ifndef COMMON_IO_SOCKET_BASE_IMPL_HPP
#include "base.impl.hpp"
#endif

#endif // #if defined(__cplusplus) && !defined(only_socket_macroses_are_used)

#endif  // #ifndef COMMON_IO_SOCKET_BASE_HPP
