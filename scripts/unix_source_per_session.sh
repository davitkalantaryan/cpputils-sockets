...
makeMainJob (){
	...
	export cpputilsSocketsRepoRoot
	echo cpputilsSocketsRepoRoot=$cpputilsSocketsRepoRoot

        source ${cpputilsSocketsRepoRoot}/contrib/cinternal/scripts/unix_source_per_session.sh ${cpputilsSocketsRepoRoot}/contrib/cinternal/scripts/unix_source_per_session.sh ${cpputilsSocketsRepoRoot}/contrib/cinternal/scripts/unix_source_per_session.sh

	case "$LD_LIBRARY_PATH" in
	        ${cpputilsSocketsRepoRoot}/sys/$lsbCode/Debug/lib:${cpputilsSocketsRepoRoot}/sys/$lsbCode/Release/lib:* )
		        echo "LD_LIBRARY_PATH for cppSockets has been already set"
			;;
		* )
		        export LD_LIBRARY_PATH=${cpputilsSocketsRepoRoot}/sys/$lsbCode/Debug/lib:${cpputilsSocketsRepoRoot}/sys/$lsbCode/Release/lib::$LD_LIBRARY_PATH
			;;
	esac
