...
#include "common/io/socket/tcpserver.hpp"
...
int socket::TcpServer::StartServerS(
...
int socket::TcpServer::InitServer(int a_nPort, bool a_bReuse, bool a_bLoopback)
{
    int nRetCode;
...
int socket::TcpServer::WaitForConnection(int a_nTimeoutMs, sockaddr_in* a_pRemoteAddr)
{
...
void socket::TcpServer::RunServer(int a_lnTimeout, TypeAccept a_fpAddClient, void* a_owner)
{
 ...
 *	1:	ok
 */
int socket::TcpServer::ServerAccept(int& a_nClientSocket, int a_lnTimeout, sockaddr_in* a_bufForRemAddress)
{
...
int socket::TcpServer::CreateServer(int a_nPort, bool a_bReuse,bool a_bLoopback)
{
	struct sockaddr_in addr;
	int rtn = -1,addr_len;
